...
public final class GenerateurTerrain
{
	...
	public GenerateurTerrain(final int width, final int height, final int roughness)
	{
		this(width, height, roughness, System.currentTimeMillis());
	}

	public GenerateurTerrain(final int width, final int height, final int roughness, final long seed)
	{
		this.width = width;
		this.height = height;
